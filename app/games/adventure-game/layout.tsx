  ...
  return (
    <div className="grid grid-cols-5">
      <div className="p-5">
        ...
        <p>
          theres gonna be a bunch of stats and stuff here, maybe like a
          character bio or something aswell
        </p>
      ...
      <div className="p-5">
        <p>
          I dont really know what goes here, maybe navigation, or more stats,
          we'll work something out, in the meantime have a like button:
        </p>
        <LikeButton />
        <p>
          actually I think an inventory type thing might be good here, I'll need
          to work out how to do global variables like in Godot though
        </p>
      </div>
    </div>
  );
